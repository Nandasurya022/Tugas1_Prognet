...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="index.php"><img src="assets/img/logo-1.png" alt="..." width="50"/></a>
                        ...
                        <div class="text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    ...
                                    <p class="mb-0 text-black-50 me-3">Di lokasi kedua ini merupakan lokasi yang airnya sangat biru sesuai dengan namanya dilokasi ini jika kalian beruntung akan melihat penyu langsung dan beberapa ikan-ikan besar lainnya. Kedalamanya hingga 4-5 meter</p><br><br>
                                    <p class="mb-0 text-black-50 me-3">Price: </p>
                                </div>
                            </div>
                        </div>
                    </div>
